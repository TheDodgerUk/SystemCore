...
namespace Photon.Pun
{
    ...
    public class PhotonTransformViewEditor : Editor
    {
        ...
        SerializedProperty pos, rot, scl, lcl, obj;
        ...
        public void OnEnable()
        {
            ...
            obj = serializedObject.FindProperty("m_MessageGameObject");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                if (obj != null)
                {
                    EditorGUILayout.PropertyField(obj, new GUIContent("Game Object"));
                }
            }
