...
namespace Photon.Pun
{
    ...
    public class PhotonStream
    {
        ...
        // if passing a write to a read, stright, and not via sending to the network and back again.
        // the first 3 ites will be null, as this is used by Photon when sent and recieved
        public const int WRITE_READ_START = 3;
        ...
        public object ReceiveIndex(int index)
        {
            if (this.IsWriting)
            {
                object obj = this.writeData[index];
                return obj;
            }
            else
            {
                object obj = this.readData[index];
                return obj;
            }
        ...
        public int ReceiveCount() => this.Count;
        public int CurrentReceiveIndex() => this.currentItem;


        public void ClearCurrentIndex() => this.currentItem = 0;
        ...
        public bool IsPeakNextValid() => (this.currentItem < (this.readData.Length - 1));
