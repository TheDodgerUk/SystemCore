...
public class ShaderUtils
{
    ...
    private static void SetupMaterialWithBlendMode(Material material, BlendMode blendMode)
    {
        switch (blendMode)
        {
            case BlendMode.Opaque:
                material.SetFloat("_Surface", (float)0);  // urp Normal
            ...
            case BlendMode.Cutout:
                ...
                break;
            case BlendMode.Fade:
                material.SetFloat("_Surface", (float)1); // urp fade
    ...
    public static void SetMode(ref UnityEngine.Material material, BlendMode mode, float? alpha = null)
    {
    ...
    public static BlendMode GetMode(Material material)
    {
