...
namespace RuntimeGizmos
{
    ...
    public class TransformGizmo : MonoBehaviour
    {
        ...
        public float handleLength = .15f;
        public float handleWidth = .002f;
        public float planeSize = .025f;
        ...
        public bool HighlightedRenderers = false;
        ...
        private bool m_IsOverGizmo;
        private bool m_IsOverGizmoPrev;
        ...
        void Update()
        {
            ...
            m_IsOverGizmoPrev = m_IsOverGizmo;
            m_IsOverGizmo = !(nearAxis == Axis.None && planeAxis == Axis.None);
        ...
        public bool IsOverGizmo() => m_IsOverGizmo;
        public bool IsOverGizmoPrev() => m_IsOverGizmoPrev;

        public bool IsActive() => m_IsOverGizmoPrev;
        ...
        public bool HasTarget() => targetRoots.Count > 0;
