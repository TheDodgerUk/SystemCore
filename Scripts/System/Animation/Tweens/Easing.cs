...
{
    // examples
    // https://www.youtube.com/watch?v=r00ZqX1ynS4
    //https://d19oqafiwfkr0c.cloudfront.net/content-image/original-be13377e-556504c0d279e.png
    Linear, Clerp, Spring,
...
public static class Easing
{
    ...
    private static float Ease(float start, float end, float t, EaseType type)
    {
        switch (type)
        {
            ...
            case EaseType.BackIn: return BackIn(start, end, t);
            case EaseType.BackOut: return BackOut(start, end, t);
            case EaseType.BackInOut: return BackInOut(start, end, t);
        }
    }
