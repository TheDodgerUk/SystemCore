...
{
	// Public Properties
	public int maxFrames = 9000; // maximum number of frames you want to record in one video
	...
	public void Start() 
	{
		...
		persistentDataPath = "E:/recordings/ScreenRecorder/ScreenRecorder";
        ...
        screenWidth = (int)res.x;
		screenHeight = (int)res.y;
