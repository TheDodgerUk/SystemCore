...
namespace TriLibCore
{
    ...
    public static class AssetLoaderZip
    {
        ...
        {
            Stream stream = null;
            var memoryStream = SetupZipModelLoading(ref stream, path, ref assetLoaderOptions, ref fileExtension, out var zipFile);
        ...
        {
            var memoryStream = SetupZipModelLoading(ref stream, null, ref assetLoaderOptions, ref fileExtension, out var zipFile);
        ...
        private static Stream SetupZipModelLoading(ref Stream stream, string path, ref AssetLoaderOptions assetLoaderOptions, ref string fileExtension, out ZipFile zipFile)
        {
            ...
            {
                throw new Exception("Unable to find a suitable model on the Zip file. Please inform a valid model file extension.");
            }
            return memoryStream;
        }
