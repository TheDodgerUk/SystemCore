...
namespace TriLibCore
{
    ...
    public class AssetLoaderFilePicker : MonoBehaviour
    {
        ...
        public void OpenFilePanelAsync(string title, Action<IList<ItemWithStream>> items)
        {
            StandaloneFileBrowser.OpenFilePanelAsync(title, null, GetExtensions(), true, items);
        }

        public IList<ItemWithStream> OpenFilePanel(string title)
        {
            return StandaloneFileBrowser.OpenFilePanel(title, null, GetExtensions(), true);
        }
